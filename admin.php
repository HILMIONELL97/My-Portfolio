        ...
        <nav id="primary-navigation" class="site-navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a href="#hero" class="site-logo"><img src="assets/img/cooltext360545949320244.png" alt="logo"></a>
...
<div id="hero" class="hero">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h1>HILMI Mohammed</h1>
                    <div class="page-scroll">
                        <p class="job-title">WEB INTEGRATOR</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <p>Hello! I'm HILMI Mohammed, a Web integrator, I’m currently available for freelance work. If you have a project that you want to get started or think you need my help with something, then get in touch.</p>
                        <a href="assets/Mon CV.pdf" class="btn btn-fill" target="_blank" download>Download my cv</a>
                    </div>
                </div>
            </div>
        </section> -->
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            <img src="assets/img/uweb.png" class="img-res" alt="">
                            <div class="portfolio-item-info">
                                <h4>YOU WEB</h4>
                                <a href="https://youweb3.netlify.com/"><span class="glyphicon glyphicon-link"></span></a>
                            </div>
                            <!-- /.portfolio-item-info -->
                        </div>
                        <!-- /.portfolio-item -->
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            <img src="assets/img/MINI-.png" class="img-res" alt="">
                            <div class="portfolio-item-info">
                                <h4>tracking-projet</h4>
                                <a href="https://tracking-projet-mh.netlify.app/"><span class="glyphicon glyphicon-link"></span></a>
                            </div>
                            <!-- /.portfolio-item-info -->
                        </div>
                        <!-- /.portfolio-item -->
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            <img src="assets/img/covid.png" class="img-res" alt="">
                            <div class="portfolio-item-info">
                                <h4>COVITEST</h4>
                                <a href="https://corona-viru.netlify.app/"><span class="glyphicon glyphicon-link"></span></a>
                            </div>
                            <!-- /.portfolio-item-info -->
                        </div>
                        <!-- /.portfolio-item -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <p class="counter start" data-to="1.5" data-speed="2000">0</p>
